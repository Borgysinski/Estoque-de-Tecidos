...
function getGroups() {
      const defaultGroups = [
        ...
        { name: "M6157 V04", image: "Midias/Linhão_Rotativo/M6157 V04.jpeg", quantity: 1 },
           ...
           { name:"Produto: 215892 Tecido Linhão Quadro 1,50 m<br>Formato: Toalha Fogão 70x70 cm<br>Composição: 71% Alg. / 29% Pes.<br>Peças com 30 metros" /*"215892 - Linhão Quadro - Fogão 1,50 m Larg. <br>Composição 71% Alg. / 29% Pes. - Peças com 30 metros"*/, items: [
